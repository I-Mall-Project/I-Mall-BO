...
// ✅ Product Analysis
import { getProductAnalysis } from "../../controllers/product/product.js";
...
router.post("/v1/products/bulk",verify, bulkCreateProducts);
...
router.put("/v1/products/:id", productEdit, verify, upload.array("images"), updateProduct);
router.put("/v1/products/attributes/:id", verify, updateProductAttribute);
router.put("/v1/products/images/:id", productEdit, verify, upload.single("image"), updateProductImage);
router.put("/v1/products/:id/viewCount", increaseProductViewCount);
router.put("/v1/products/:id/ban", productBan, verify, banProduct);
router.delete("/v1/products/images/:id", productRemove, verify, deleteProductImage);
...
router.post("/v1/products-images", verify, upload.single("image"), createProductImage);
router.delete("/v1/products-images/:id", verify, deleteProductImage);

// ✅ Product Analysis
router.get("/v1/analysis/products", verify, getProductAnalysis);
